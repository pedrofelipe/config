...
3. **Evaluate Code Quality**
   ...
   **UI Polish**
   - When reviewing changes that involve UI polish, spacing, surfaces, animations, or typography, load `skill({ name: "make-interfaces-feel-better" })`. Use its checklist to verify the changes follow established UI polish patterns.
